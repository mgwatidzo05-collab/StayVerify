            ...
            <div className="bg-slate-50 border border-slate-200 rounded-xl p-3.5 space-y-2">
              <div className="flex items-center justify-between flex-wrap gap-1">
                <label className="text-xs font-bold text-slate-800 flex items-center gap-1.5">
                  ...
                  <span>Google Map Location / Pin Link</span>
                  <span className="text-[10px] font-normal text-slate-500">(Optional but recommended)</span>
                </label>
                <a
                  href={`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent((address ? address + ', ' : '') + suburb + ', Bulawayo')}`}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-[11px] font-semibold text-rose-600 hover:text-rose-700 flex items-center gap-1 transition"
                >
                  <span>Find pin on Google Maps</span>
              ...
              <input
                ...
                placeholder="Paste Google Maps URL or share link (e.g. https://maps.app.goo.gl/... or https://google.com/maps?q=...)"
              ...
              <p className="text-[11px] text-slate-500 leading-relaxed">
                Enter your Google Maps pin or location link. Students will be able to see the exact map location and get walking directions straight from the NUST main campus gate.
              </p>
            </div>
