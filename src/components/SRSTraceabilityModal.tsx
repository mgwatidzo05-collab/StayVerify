      ...
      <div className="bg-white rounded-2xl max-w-4xl w-full max-h-[92vh] flex flex-col shadow-2xl border border-slate-200 overflow-hidden">
        ...
        <div className="px-6 py-4 bg-slate-900 text-white flex items-center justify-between border-b border-slate-800">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-base font-bold">StayVerify SRS Requirements Traceability Matrix</h2>
              <p className="text-[11px] text-slate-400">
                National University of Science and Technology (NUST) &bull; Prepared by: Tapiwa &bull; Document Version 1.0
              </p>
            </div>
          </div>
          <button
        ...
        <div className="bg-slate-50 px-6 py-3 border-b border-slate-200 flex flex-wrap gap-2 text-xs">
          ...
          >
            Account & Verification (FR-01 to FR-06)
          </button>
          <button
          ...
          >
            Listings & Matching (FR-07 to FR-12)
          </button>
          <button
          ...
          >
            Anti-Scam Shield (FR-16 to FR-20)
          </button>
          <button
          ...
          >
            Admin & Housing Office (FR-21 to FR-23)
          </button>
        </div>
                ...
                <div className="space-y-1 max-w-2xl">
                  <div className="flex items-center gap-2">
                    ...
                    <span className={`text-[10px] font-bold px-1.5 py-0.2 rounded uppercase ${
                      req.priority === 'Must' ? 'bg-red-100 text-red-800' : req.priority === 'Should' ? 'bg-blue-100 text-blue-800' : 'bg-slate-100 text-slate-700'
                    }`}>
                      MoSCoW: {req.priority}
                    </span>
                  </div>
